...
try {
    ...
    $search = $_POST['kategoria'];

    $stmt = $conn->prepare("SELECT tpkt_user, tpkt_cim, tpkt_helyszin, tpkt_leiras, tpkt_kep, tpkt_kategoria FROM userinfo WHERE tpkt_kategoria = '$search'"); 
    $stmt->execute();
